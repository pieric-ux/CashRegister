...
export default function DeleteAppForm({ application, translations }) {
    ...
    return (
        <section>
            <DangerButton onClick={confirmAppDeletion} className='!px-2' aria-label={translations.ariaDeleteAppButton}>
            ...
            <Modal show={confirmingAppDeletion} onClose={closeModal}>
                <form onSubmit={deleteApp} className="p-6">
                    ...
                    <div className="mt-6 flex justify-end">
                        ...
                        <DangerButton className="ml-3" disabled={processing} aria-label={translations.ariaDeleteAppButton}>
                            {translations.deleteAppTitle}
                        </DangerButton>
                    </div>
                </form>
            </Modal>
