...
export default function Index({ customerAuth, applications, GlobalTranslations, translations }) {

    return (
        <CustomerLayout auth={customerAuth} GlobalTranslations={GlobalTranslations}>
            <Head title={GlobalTranslations.applications} />
            ...
            <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 space-y-6">
                <div className="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow-md rounded-lg transition ease-linear duration-300">
                    <CreateAppForm className="max-w-xl mx-auto" translations={translations} />
                </div>
                ...
                {applications.length > 0 ? (
                                ...
                                <div className="relative flex md:flex-row lg:gap-12 md:gap-10 flex-col sm:p-8 p-4 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 shadow-md rounded-lg transition ease-linear duration-300">
                                    <div className='absolute top-4 right-4 flex gap-2'>
                                        <Link href={route('applications.show', application.slug)} tabIndex='-1'>
                                            <PrimaryButton className='!px-2' aria-label={translations.ariaConfigureApplicationButton}>
                                        ...
                                        <UpdateAppForm application={application} translations={translations} />
                                        <DeleteAppForm application={application} translations={translations} />
                                    </div>
                                    <div className='flex items-center justify-center md:mt-0 mt-8'>
                                        <UpdateAppPoster application={application} translations={translations} />
                                    </div>
                    ...
                    <div className="p-4 sm:p-8 text-center bg-white dark:bg-gray-800 shadow sm:rounded-lg transition ease-linear duration-300">
                        <p className='text-gray-900 dark:text-gray-100'>{translations.noApplicationFound}</p>
                    </div>
                )}
