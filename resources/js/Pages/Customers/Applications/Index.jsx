                    ...
                    <ul>
                        {applications.map((application) => (
                            <li className="my-4" key={application.id}>
                                {/* Application Card */}
                                <div className="relative flex flex-col rounded-lg bg-white p-4 text-gray-900 shadow-md transition duration-300 ease-linear dark:bg-gray-800 dark:text-gray-100 sm:p-8 md:flex-row md:gap-10 lg:gap-12">
