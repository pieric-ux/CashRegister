...
import DeleteTransaction from '@/Pages/Customers/Modules/CashRegisterModule/Configurations/Transactions/Components/DeleteTransaction';
import {
    type ColumnDef,
    ...
    return (
        <div className={clsx('space-y-6', className)}>
            <div className='flex items-center justify-between gap-4'>
                ...
                <DeleteTransaction
                    transactions={originalRows as Transaction[]}
