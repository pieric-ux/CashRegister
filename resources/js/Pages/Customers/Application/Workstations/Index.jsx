...
export default function Index({
    ...
    const [updatedWorkstations, setUpdatedWorkstations] =
    ...
    const onDragEnd = async (result) => {
        ...
        const sourceType = source.droppableId.includes("employee")
            ? "employees"
            : "products";
        ...
        if (sourceType === "employees") {
            ...
            if (sourceWorkstation === destinationWorkstation) {
                ...
                destinationWorkstation.cr_employees.splice(
                    destination.index,
                    0,
                    movedEmployee,
                );
            ...
            if (sourceId === 0) {
                ...
                destinationWorkstation.cr_products.splice(
                    destination.index,
                    0,
                    movedProduct,
                );
                ...
                sourceWorkstation.generalProducts.splice(
                    destination.index,
                    0,
                    movedProduct,
                );
