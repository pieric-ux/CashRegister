...
export default function Index({
    ...
    const transactionsColumns = [
        ...
        },
        {
            ...
            render: (transaction) =>
                `${transaction.total} ${t("currency_symbol")}`,
        },
        {
            key: "paymentMethod",
            ...
            className: "hidden xl:table-cell",
            render: (transaction) =>
                `${t(transaction.cr_payment_methods.name)}`,
        },
    ];
    ...
    const sortedByCreationDateTransactions = transactions
        .slice()
        .sort((a, b) => {
    ...
    const indexOfFirstTransactions =
        indexOfLastTransactions - transactionPerPage;
