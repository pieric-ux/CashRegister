...
export default function DeleteTransactionForm({ transaction }) {
    ...
    return (
        <section>
            <DangerButton onClick={confirmTransactionDeletion} className='!px-2' aria-label={t('Delete the transaction')}>
            ...
            <Modal show={confirmingTransactionDeletion} onClose={closeModal}>
                <form onSubmit={deleteTransaction} className="p-6">
                    ...
                    <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        {t('Once your transaction is deleted, all of its resources and data will be permanently deleted. Please enter your password to confirm you would like to permanently delete your transaction.')}
                    </p>
                    ...
                    <div className="mt-6 flex justify-end">
                        ...
                        <DangerButton className="ml-3" disabled={processing} aria-label={t('Delete the transaction')}>
