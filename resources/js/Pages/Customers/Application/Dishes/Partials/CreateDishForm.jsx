...
export default function CreateDishForm({ application, className = '' }) {
    ...
    return (
        <section className={`space-y-6 ${className}`}>
            <header>
                <h1 className="text-lg font-medium text-gray-900 dark:text-gray-100">{t('Create a Dish')}</h1>

                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    {t('Don\'t have any dish yet? Looking to add another one? Click the \'Create\' button to begin.')}
                </p>
            </header>
            <PrimaryButton onClick={openModal} aria-label={t('Create your dish')}>{t('Create')}</PrimaryButton>
            ...
            <Modal show={openingModal} onClose={closeModal}>
                ...
                <form onSubmit={submit} className="p-6">
                    ...
                    <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        {t('Ready to create a new dish? Fill out the form below with the required details and hit the \'Create\' button to get started.')}
                    </p>
                    ...
                    <div className="mt-6 flex justify-end">
                        ...
                        <PrimaryButton className="ml-3" disabled={processing} aria-label={t('Create your dish')}>
                            {t('Create')}
                        </PrimaryButton>
                    </div>
                </form>
