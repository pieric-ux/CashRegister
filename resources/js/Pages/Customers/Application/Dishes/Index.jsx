...
export default function Index({ customerAuth, application, dishes, localization }) {
    ...
    const dishesColumns = [
        ...
        { key: "cost_price", label: t('Cost Price'), className: "hidden lg:table-cell", render: (dish) => `${dish.client_price} ${t('currency_symbol')}` },
        {
            key: "is_consigned", label: t('Consigned'), className: "hidden lg:table-cell", render: (dish) => (
