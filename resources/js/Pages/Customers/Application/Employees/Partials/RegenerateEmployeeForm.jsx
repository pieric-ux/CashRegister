...
export default function RegenerateEmployeeForm({ employee, translations }) {
    const { patch } = useForm({});
    ...
    return (
        <PrimaryButton onClick={regenerateEmployeeActivation} className='!px-2' aria-label={translations.ariaRegenerateEmployeeButton}>
