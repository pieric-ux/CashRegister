...
export default function UpdateEmployeeForm({ employee, className = '' }) {
    ...
    return (
        <section className={`space-y-6 ${className}`}>
            <PrimaryButton onClick={openModal} className='!px-2' aria-label='Edit your employee'>
            ...
            <Modal show={openingModal} onClose={closeModal}>
                ...
                <form onSubmit={submit} className='p-6'>
                    ...
                    <div className="mt-6 flex justify-end">
                        ...
                        <PrimaryButton className='ml-3' disabled={processing} aria-label='Edit your employee'>
                            Save
                        </PrimaryButton>
                    </div>
                </form>
