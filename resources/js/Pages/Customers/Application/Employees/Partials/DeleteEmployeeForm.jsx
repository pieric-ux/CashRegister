...
export default function DeleteEmployeeForm({ employee, translations }) {
    ...
    return (
        <section>
            <DangerButton onClick={confirmEmployeeDeletion} className='!px-2' aria-label={translations.ariaDeleteEmployeeButton}>
            ...
            <Modal show={confirmingEmployeeDeletion} onClose={closeModal}>
                <form onSubmit={deleteEmployee} className="p-6">
                    ...
                    <div className="mt-6 flex justify-end">
                        ...
                        <DangerButton className="ml-3" disabled={processing} aria-label={translations.ariaDeleteEmployeeButton}>
                            {translations.deleteEmployeeTitle}
                        </DangerButton>
                    </div>
                </form>
            </Modal>
