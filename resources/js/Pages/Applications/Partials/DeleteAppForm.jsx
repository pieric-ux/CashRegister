...
export default function DeleteAppForm({ application }) {
    ...
    return (
        <section>
            <DangerButton onClick={confirmAppDeletion}>Delete</DangerButton>
            ...
            <Modal show={confirmingAppDeletion} onClose={closeModal}>
                <form onSubmit={deleteApp} className="p-6">
                    ...
                    <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        Once your app is deleted, all of its resources and data will be permanently deleted. Please
                        enter your password to confirm you would like to permanently delete your app.
                    </p>
