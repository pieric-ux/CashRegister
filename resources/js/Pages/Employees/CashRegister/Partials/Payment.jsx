    ...
    return (
        <>
            ...
            <Modal show={openingModal} onClose={closeModal}>
                <div className='flex flex-col gap-4 rounded-lg bg-white p-4 text-gray-900 shadow-md transition duration-300 ease-linear sm:p-8 dark:bg-gray-800 dark:text-gray-100'>
