    ...
    return (
        <Link
            ...
            className={`w-full flex items-start pl-3 pr-4 py-2 border-l-4 ${active
                ? 'border-sky-400 dark:border-sky-600 text-sky-700 dark:text-sky-300 bg-sky-50 dark:bg-indigo-900/50 focus:text-sky-800 dark:focus:text-sky-200 focus:bg-indigo-100 dark:focus:bg-sky-900 focus:border-sky-700 dark:focus:border-sky-300'
