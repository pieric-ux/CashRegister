...
export default function CR_AppAdminLayout({ auth, application, children, localization }) {
    ...
    const RespNavLink = (
        <>
            ...
            <ResponsiveNavLink href={route('transactions.index', application.slug)} active={route().current('transactions.index', application.slug)}>
                {t('Transactions')}
            </ResponsiveNavLink>
        ...
        <div className="bg-gray-100 dark:bg-gray-900 transition ease-linear duration-300">
            ...
            <div className="flex h-screen overflow-hidden">
                ...
                <Sidebar sideBarOpen={sideBarOpen} setSideBarOpen={setSideBarOpen}>
                    ...
                    <SideBarLink href={route('dishes.index', application.slug)} active={route().current('dishes.index', application.slug)}
                        svg={
                    ...
                    <SideBarLink href={route('transactions.index', application.slug)} active={route().current('transactions.index', application.slug)}
                        svg={
                            <svg className="w-5 h-5 text-gray-600 dark:text-gray-300" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
