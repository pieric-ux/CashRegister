        ...
        <div className="bg-gray-100 dark:bg-gray-900 transition ease-linear duration-300">
            ...
            <div className="flex h-screen overflow-hidden">
                ...
                <div className="relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden">
                    {/* Header Start*/}
                    <Header user={auth.customer} avatarPath={auth.avatarPath} RespNavLink={RespNavLink} DropdownLink={DropdownLink} sideBarOpen={sideBarOpen} setSideBarOpen={setSideBarOpen} localization={localization} />
                    {/* Header End*/}
