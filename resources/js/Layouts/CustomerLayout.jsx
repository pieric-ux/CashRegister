...
export default function CustomerLayout({ user, header, children }) {
                        ...
                        <ul className="space-y-2 font-medium">
                            <li>
                                <SideBarLink href={route('dashboard')} active={route().current('dashboard')}
                                    svg={<svg className="w-5 h-5 text-gray-600 dark:text-gray-300" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
