    ...
    return data.slice().sort((a, b) => {
        if (sortColumn) {
            ...
            if (
                ...
                sortColumn === "is_consigned" ||
                sortColumn === "is_SoldSeparately"
            ) {
    ...
    return data.filter((item) =>
        columns.some((column) => {
            ...
            if (typeof value === "string") {
                ...
                if (
                    column.key === "is_consigned" &&
                    searchTermLowerCase === t("consigned")
                ) {
                    return value === 1;
                } else {
                ...
                const categoryName =
                    item.cr_categories_products?.name?.toLowerCase();
                ...
                const paymentMethodName =
                    item.cr_payment_methods?.name?.toLowerCase();
